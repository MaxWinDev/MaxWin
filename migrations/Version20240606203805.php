 ...
 */
final class Version20240606203805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE win ADD CONSTRAINT FK_B0CA3B76A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
